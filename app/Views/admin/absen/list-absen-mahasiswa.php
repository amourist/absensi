<div class="card-body">
    <div class="row">
        ...
        <div class="col">
            <a href="#" class="btn btn-primary pl-3 mr-3 mt-3" onclick="matkul = onDateChange()" data-toggle="tab">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!$lewat && (user()->toArray()['is_superadmin'] == 1 || user()->toArray()['is_superadmin'] == 3)) : ?>
                                    <button data-toggle="modal" data-target="#ubahModal" onclick="getDataKehadiran(<?= $value['id_presensi'] ?? '-1'; ?>, <?= $value['id_mahasiswa']; ?>)" class="btn btn-info p-2" id="<?= $value['nis']; ?>">
