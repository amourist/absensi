...
<table>
   <tr>
      ...
      <td width="100%">
         ...
         <h4 align="center"><?= $generalSettings->nama_prodi; ?></h4>
         <h4 align="center">TAHUN AJARAN <?= $generalSettings->tahun_ajaran; ?></h4>
      </td>
      <td>
...
<span style="position: absolute;right: 0;">Kelas : <?= "{$matkul['matkul']}"; ?></span>
...
<table>
   <tr>
      ...
      <td>: <?= count($listMahasiswa); ?></td>
   </tr>
   <tr>
      <td>Laki-laki</td>
      <td>: <?= $rekapMahasiswa['laki']; ?></td>
   </tr>
   <tr>
      <td>Perempuan</td>
      <td>: <?= $rekapMahasiswa['perempuan']; ?></td>
   </tr>
</table>
<?php
