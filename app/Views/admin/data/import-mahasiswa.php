                ...
                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div id="csv_upload_spinner" class="csv-upload-spinner">
                                                <strong class="text-csv-importing">Importing Mahasiswa...</strong>
                    ...
                    <div class="col-12 col-xl-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?= base_url('admin/mahasiswa/downloadCSVFilePost'); ?>" method="post">
                                    <?= csrf_field(); ?>
                                    <button type="button" class="btn btn-success btn-block" data-toggle="modal" data-target="#modalMatkul">List Matkul</button>
                                    <button class="btn btn-success btn-block" name="submit" value="csv_mahasiswa_template">Download CSV Template</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="modalMatkul" tabindex="-1" aria-labelledby="modalMatkulTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalMatkulTitle">List Matkuls</h5>
...
<script>
    $(function() {
        $('#drag-and-drop-zone').dmUploader({
            url: '<?= base_url("admin/mahasiswa/generateCSVObjectPost"); ?>',
            multiple: false,
            extFilter: ["csv"],
    ...
    function addCSVItem(numberOfItems, txtFileName, index) {
        if (index <= numberOfItems) {
            ...
            $.ajax({
                type: "POST",
                url: '<?= base_url("admin/mahasiswa/importCSVItemPost"); ?>',
